...
<div hidden={!$state.showAlert} style="font-family: 'Inter'; position: fixed; right: 10px; bottom: 0px; z-index: 1000;">
    {#if $state.alertType == "warning"}
        <div id="toast-warning" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
            ...
            <div class="ml-3 text-sm font-normal alert-text">{$state.alertText}</div>
    ...
    {:else if $state.alertType == "danger"}
...
<style>
    .alert-text {
        white-space: normal;
        overflow: auto;
        max-height: 200px;  /* you can adjust this as per your requirement */
    }
</style>