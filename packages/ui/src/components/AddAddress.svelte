        ...
        <div class="group-4448">
            <div class="group-4446">
                <div class="group-4444">
                    ...
                    <svg on:click={() => open = false} class="w-6 h-6 text-white cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
